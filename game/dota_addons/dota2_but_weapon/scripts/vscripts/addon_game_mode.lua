...
function Precache( context )
	...
	PrecacheResource("particle", "particles/custom/area_1000.vpcf", context)
	PrecacheResource("particle", "particles/custom/area_1500.vpcf", context)
	PrecacheResource("particle", "particles/custom/area_2000.vpcf", context)
	PrecacheResource("particle", "particles/custom/area_2500.vpcf", context)
	PrecacheResource("particle", "particles/custom/area_3000.vpcf", context)
